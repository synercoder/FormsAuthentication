...
namespace Synercoding.FormsAuthentication
{
        ...
        where TData : AuthenticationTicket
    {
        ...
        public FormsAuthenticationDataFormat(FormsAuthenticationOptions options, Func<FormsAuthenticationCookie, TData> from, Func<TData, FormsAuthenticationCookie> to)
        {
